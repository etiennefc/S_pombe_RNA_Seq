...
rule average_normalized_tables:
    ...
    output: 
        Normal_input_df = os.path.join(config['path']['extract_read_type'], 'Normal_input_avg_normalized_df.tsv'),
        Normal_IP_df = os.path.join(config['path']['extract_read_type'], 'Normal_IP_avg_normalized_df.tsv'),
        H2O2_input_df = os.path.join(config['path']['extract_read_type'], 'H2O2_input_avg_normalized_df.tsv'),
        H2O2_IP_df = os.path.join(config['path']['extract_read_type'], 'H2O2_IP_avg_normalized_df.tsv'),
        Heat_input_df = os.path.join(config['path']['extract_read_type'], 'Heat_input_avg_normalized_df.tsv'),
        Heat_IP_df = os.path.join(config['path']['extract_read_type'], 'Heat_IP_avg_normalized_df.tsv'),
        Stat_input_df = os.path.join(config['path']['extract_read_type'], 'Stat_input_avg_normalized_df.tsv'),
        Stat_IP_df = os.path.join(config['path']['extract_read_type'], 'Stat_IP_avg_normalized_df.tsv'),
        yAS99_df = os.path.join(config['path']['extract_read_type'], 'yAS99_avg_normalized_df.tsv'),
